...
features:
  - title: "Metodología: La Ciencia Detrás del Acuerdo"
    ...
    bulletpoints:
      ...
      - "Análisis geoespacial y de sentimiento ciudadano."
      - "Identificación de zonas de fricción y áreas de oportunidad."
    button:
      enable: true
      label: "Descargar Whitepaper" # Ideal para captar leads que aún no quieren la videollamada
  ...
  - title: "Sector Privado: Viabilidad y Desarrollo"
    ...
    bulletpoints:
      ...
      - "Gestión de impacto comunitario para proyectos de infraestructura."
      - "Diseño urbano regenerativo y place-making."
    button:
      enable: false
      label: ""
      link: ""
  ...
  - title: "Sector Público: Gobernanza Participativa"
    ...
    bulletpoints:
      ...
      - "Mediación comunitaria y resolución de conflictos."
      - "Diseño de políticas públicas participativas informadas por datos."
    button:
      enable: false
      label: ""
      link: ""
...
{{< dataviz title="Demostración Técnica: Inteligencia Territorial" subtitle="Ejemplo de aplicación: Cruce de imágenes satelitales Landsat 8 y datos sociodemográficos para identificar vulnerabilidad climática y trazar rutas de cuidado en la ciudad." >}}